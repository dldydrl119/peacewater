$(document).ready(function(){
    ...
    function admin() {
        ...
        this.charge = function() {
            ...
            $('body').on('click', '#charge_addBtn', function() {
                var category = $('#myTab > li.active > a').data('category');;
                if(category) {
                    location.href = "/admin/charge/add/"+category;
                }
            });


            $('body').on('click', '#idxs_1go, #idxs_2go, #idxs_3go, #idxs_4go, #idxs_5go, #idxs_6go', function() {
                var category = $('#myTab > li.active > a').data('category');
