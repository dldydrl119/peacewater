                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="category">
                                        <?foreach ($category_arr as $key=> $cate):?>
                                            <option value="<?=$key?>" <?if(isset($data->name) && $key == $data->name) echo 'selected'; elseif( $key == $category) echo 'selected' ?>><?=$cate?></option>
                                        <?endforeach;?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> 가격 <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <?if(isset($data) && !empty($data)) { $id="chargeedit"; $text="수정하기"; } else { $id="chargego"; $text="등록하기";}?>
