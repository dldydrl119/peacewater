                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left">
                            ...
                            <?if($memo_func):?>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> 내용 <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <?if(isset($data) && !empty($data)) { $id="facilityedit"; $text="수정하기"; } else { $id="facilitygo"; $text="등록하기";}?>
