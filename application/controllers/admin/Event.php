...
//            $this->json(array('return'=>false, 'err_msg'=>'데이터 제한수를 넘었습니다.'));
    ...
    public function addData()
    {
        ...
        if($this->memo_func) {
            $insert_data['memo_fun'] = $this->input->post('memo_fun');
    ...
    public function edit($idx) //보기
    {
        ...
        $this->load->view($this->ldir . '/admin_header');
        $this->load->view($this->ldir. '/event_add',$data);
        $this->load->view($this->ldir . '/admin_footer');
    }
    ...
    public function editData()
    {
        ...
        if($this->memo_func) {
            $update_data['memo_fun'] = $this->input->post('memo_fun');
